    ...
    formSubmitBtn.addEventListener('click', (e) => {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                if (data.errors.name) {
                    changeToF(formName);
                    document.getElementById('send-error').innerHTML = `<small class="error-text"><i class="fa fa-exclamation-triangle"></i>Error on Name: ${data.errors.name}</small>`
                } else {
                    changeToS(formName);
                    document.getElementById('send-error').innerHTML = '';
                }
                ...
                if (data.errors.email) {
                    changeToF(formEmail);
                    document.getElementById('send-error').innerHTML = `<small class="error-text"><i class="fa fa-exclamation-triangle"></i>Error on Email:  ${data.errors.email}</small>`
                } else {
                    changeToS(formEmail);
                    document.getElementById('send-error').innerHTML = '';
                }
                if (data.errors.message) {
                    ...
                    document.getElementById('send-error').innerHTML = `<small class="error-text"><i class="fa fa-exclamation-triangle"></i>Error on Message:  ${data.errors.message}</small>`
                } else {
